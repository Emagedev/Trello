...
/**
 * Class Omedrec_Trello_Test_Model_Api_Adapter
 */
class Omedrec_Trello_Test_Model_Api_Adapter extends EcomDev_PHPUnit_Test_Case
{
    ...
    {
        /** @var Omedrec_Trello_Model_Api_Adapter $adapter */
