...
/**
 * Class Omedrec_Trello_Test_Model_Observer
 */
class Omedrec_Trello_Test_Model_Observer extends EcomDev_PHPUnit_Test_Case
{
    ...
    {
        /** @var Omedrec_Trello_Model_Observer $observer */
