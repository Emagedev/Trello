 ...
 */
class Emagedev_Trello_Block_Adminhtml_Member extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    /**
     * Init grid container
     */
    public function __construct()
    {
        ...
        $this->_headerText = $this->__('Trello Members');

        /** @var Emagedev_Trello_Helper_Data $helper */
        $helper = Mage::helper('trello');

        $this->_addButton('fetch', array(
            'label'     => $helper->isConnectionSet() ? $this->__('Fetch Members From Board') : $this->__('Please Set Up Connection'),
    ...
    {
        return $this->getUrl('*/*/fetchMembers');
    }
}
